...
> Data: `routes.json` / `stops.json` generated at 2026-08-22T15:27:55+00:00.
...
|---|---|
| stops (nodes) | 4938 |
| route variants (patterns) | 1088 |
| pattern-stop entries | 61090 |
| footpath edges (directed, ≤ 400 m) | 53300 |
...
| plan time mean / max | 3.4 ms / 9 ms |
| itineraries offered, mean | 1.54 |
| transfers in the best itinerary, mean | 1.38 |
| ride legs across all offered itineraries | 695 |

### Drawn vs charged (ride legs)

Length of the drawn slice ÷ the distance the planner charged for, over
695 ride legs (0 leg(s) without drawable geometry).

| metric | value |
|---|---|
| min / p05 / p50 / p95 / p99 / max | 0.95 / 0.95 / 0.99 / 1.08 / 1.28 / 1.67 |
...
From stop 4772 to every 17th stop: **291/291
