...
const STRINGS = {
    es: {
        ...
        'support.link': 'Apoyá al autor',
        'support.title': 'Apoyá el proyecto con una donación por Ko-fi',
    ...
    en: {
        ...
        'support.link': 'Support the author',
        'support.title': 'Support the project with a Ko-fi donation',
    ...
    ru: {
        ...
        'support.link': 'Поддержать автора',
        'support.title': 'Поддержать проект донатом через Ko-fi',
